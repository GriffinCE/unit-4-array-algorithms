...
public class ArrayListAlgorithms {
   ...
   */
   ...
   public boolean isInArray(int intToFind) {
      ...
      System.out.print("Is the number " + intToFind + " in the array? ");
   ...
   public static void main(String[] args) {
      ...
      System.out.println("Does the array have duplicates? " + newArray.hasDuplicates());
      System.out.println(newArray.isInArray(49));
   }
}
